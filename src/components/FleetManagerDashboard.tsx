...
export default function FleetManagerDashboard({
  ...
  return (
    <>
      ...
      <section id="bento_telemetry" className="lg:col-span-12 grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <section id="bento_assets" className="lg:col-span-3 flex flex-col gap-6 h-full">
        <div className="transition-all duration-500 ease-out h-full flex flex-col border border-cyan-500/20 shadow-[0_0_25px_rgba(6,182,212,0.06)] rounded-3xl overflow-hidden">
          <div className="bg-[#090b1c]/85 backdrop-blur-xl p-5 rounded-3xl border border-slate-800 flex-1 flex flex-col gap-4">
            ...
            <div className="flex-1 max-h-[310px] overflow-y-auto pr-1 flex flex-col gap-2.5">
              {vehicles.map((v) => {
            ...
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              ...
              {isDispatching ? (
                ...
                <button
                  ...
                  className="px-4 py-1.5 bg-cyan-500 text-slate-950 hover:bg-cyan-400 rounded-xl font-bold font-mono text-xs tracking-wide transition-all duration-300 flex items-center gap-1.5 glow-cyan cursor-pointer animate-pulse"
                >
                  <Plus className="w-4 h-4 text-slate-950" /> LAUNCH DISPATCH
                </button>
              )}
            </div>
            ...
            {!isDispatching ? (
              <div className="flex-1 flex flex-col gap-4">
                ...
                <div className="relative border border-slate-800/80 rounded-2xl bg-slate-950/60 p-4 overflow-hidden h-[340px] flex flex-col items-center justify-center">
                  ...
                  <svg className="w-full h-full min-h-[300px]" viewBox="0 0 600 300" preserveAspectRatio="xMidYMid meet">
                    ...
                    {/* Moving Vehicle Nodes (Active Trips) */}
              ...
              <form onSubmit={handleLaunchDispatch} className="flex-1 flex flex-col gap-4 text-slate-200">
                ...
                <div className="flex items-center gap-4 mt-auto">
                  ...
                  <button
                    type="submit"
                    className="flex-1 py-3 bg-cyan-500 hover:bg-cyan-400 text-slate-950 rounded-xl font-black font-mono text-xs tracking-wider transition-all duration-300 glow-cyan cursor-pointer"
                  >
                    AUTHORIZE & DISPATCH
                  </button>
                </div>
      ...
      <section id="bento_logistics" className="lg:col-span-3 flex flex-col gap-6 h-full">
        <div className="transition-all duration-500 ease-out h-full flex flex-col border border-cyan-500/20 shadow-[0_0_25px_rgba(6,182,212,0.06)] rounded-3xl overflow-hidden">
          <div className="bg-[#090b1c]/85 backdrop-blur-xl p-5 rounded-3xl border border-slate-800 flex-1 flex flex-col gap-4">
            ...
            <div className="flex-1 max-h-[170px] overflow-y-auto pr-1 flex flex-col gap-2.5">
              {fuelLogs.map((log) => {
