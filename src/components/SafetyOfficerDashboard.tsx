  ...
  return (
    <>
      ...
      <section id="safety_metrics" className="lg:col-span-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-[#090b1c]/80 backdrop-blur-xl p-5 rounded-2xl border border-cyan-500/20 shadow-[0_0_25px_rgba(6,182,212,0.06)] relative overflow-hidden group">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-baseline gap-2">
              <h2 className="text-3xl font-display font-black text-white tracking-tight">{averageSafetyScore} <span className="text-sm text-slate-500 font-normal">/ 5.0</span></h2>
              <span className="text-[10px] text-emerald-400 font-mono flex items-center gap-0.5">
                <TrendingUp className="w-3 h-3" /> DOT Class I
              </span>
            </div>
            <p className="text-[11px] text-slate-400">Weighted average rating of active CDL operators.</p>
          </div>
        </div>

        {/* Card 2: Revoked / Suspended Licenses */}
        <div className="bg-[#090b1c]/80 backdrop-blur-xl p-5 rounded-2xl border border-red-500/20 shadow-[0_0_25px_rgba(239,68,68,0.06)] relative overflow-hidden group">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-baseline gap-2">
              <h2 className="text-3xl font-display font-black text-white tracking-tight">{suspendedDriversCount} <span className="text-sm text-slate-500 font-normal">/ {totalDriversCount} seat-limits</span></h2>
            ...
            <p className="text-[11px] text-slate-400">Total credentials blocked due to license expiry or safety issues.</p>
          </div>
        </div>

        {/* Card 3: Live Compliance Auditing */}
        <div className="bg-[#090b1c]/80 backdrop-blur-xl p-5 rounded-2xl border border-indigo-500/20 shadow-[0_0_25px_rgba(99,102,241,0.06)] relative overflow-hidden group">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-baseline justify-between">
              <h2 className="text-3xl font-display font-black text-white tracking-tight">ACTIVE</h2>
              <span className="text-[11px] font-mono text-indigo-400">100% ELD SYNC</span>
            </div>
            <p className="text-[11px] text-slate-400">Hours of Service (HOS) logs synchronized via live telemetry feed.</p>
          </div>
        </div>
      ...
      <section id="safety_drivers_grid" className="lg:col-span-8 h-full">
        <div className="bg-[#090b1c]/80 backdrop-blur-xl p-6 rounded-3xl border border-slate-800 flex flex-col gap-4 h-full">
          
          <div className="border-b border-slate-800 pb-3 flex items-center justify-between">
            <div>
              <h3 className="text-sm font-mono font-bold tracking-wider text-slate-200">FLEET CDL COMPLIANCE REGISTRY</h3>
              <p className="text-[10px] text-slate-400 font-mono">Verify state licensing status, FMCSA limits, and toggle operator suspensions</p>
            </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-1">
                        <h4 className="text-xs font-display font-semibold text-slate-100 truncate">{driver.name}</h4>
                      ...
                      <p className="text-[9.5px] font-mono text-slate-500">ID: {driver.id} // HOS Limit: {driver.hoursRemaining} hrs</p>
                    </div>
                  </div>

                  {/* License and Safety Stats details */}
                  <div className="grid grid-cols-2 gap-3 p-3 bg-slate-950/80 border border-slate-900 rounded-xl font-mono text-[10px]">
                    <div>
                      <span className="block text-slate-500 text-[8px] uppercase">LICENSE CLASSIFICATION</span>
                      <span className={`font-semibold ${isSuspended ? "text-red-400 line-through" : "text-slate-300"}`}>
                        {driver.licenseType.replace(" (Suspended)", "")}
                      </span>
                    </div>
                    <div>
                      <span className="block text-slate-500 text-[8px] uppercase">LICENSE EXPIRATION</span>
                      <span className={`font-semibold ${isSuspended ? "text-red-400 font-bold" : "text-slate-300"}`}>
                        {expDate}
                      </span>
                    </div>
                    <div>
                      <span className="block text-slate-500 text-[8px] uppercase">TELEMETRY SCORE</span>
                      <span className="font-bold text-white flex items-center gap-1">
                        <Star className="w-3 h-3 text-amber-400 fill-amber-400" /> {driver.rating}
                      </span>
                    </div>
                    <div>
                      <span className="block text-slate-500 text-[8px] uppercase">RISK LEVEL ASSESSMENT</span>
      ...
      <section id="safety_checklists" className="lg:col-span-4 h-full">
        <div className="bg-[#090b1c]/80 backdrop-blur-xl p-6 rounded-3xl border border-slate-800 flex flex-col gap-4 h-full">
          ...
          <div className="border-b border-slate-800 pb-3 flex items-center gap-2">
            ...
            <div>
              <h3 className="text-xs font-mono font-bold tracking-widest text-slate-200">DOT AUDIT ENGINE</h3>
              <p className="text-[9px] text-slate-500 font-mono">Electronic safety checklist verification</p>
            </div>
          </div>
          ...
          <div className="space-y-3.5 text-xs font-mono">
            ...
            <div className="p-3 bg-slate-950/60 rounded-xl border border-slate-900 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <span className="block text-[10px] text-slate-300 font-bold">ELD SYNC ENGINE</span>
                <span className="text-[9px] text-slate-500">Live Hours of Service tracking active</span>
              </div>
            </div>
            ...
            <div className="p-3 bg-slate-950/60 rounded-xl border border-slate-900 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <span className="block text-[10px] text-slate-300 font-bold">CLEARINGHOUSE STATUS</span>
                <span className="text-[9px] text-slate-500">Active records verified via FMCSA database</span>
              </div>
            </div>
            ...
            <div className="p-3 bg-slate-950/60 rounded-xl border border-slate-900 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <span className="block text-[10px] text-slate-300 font-bold">ANNUAL VEHICLE INSPECTIONS</span>
                <span className="text-[9px] text-slate-500">2 registry assets due for standard inspection</span>
              </div>
            </div>

            <div className="p-4 bg-indigo-950/10 border border-indigo-500/10 rounded-2xl space-y-2 mt-4 text-[11px] leading-relaxed text-slate-400">
