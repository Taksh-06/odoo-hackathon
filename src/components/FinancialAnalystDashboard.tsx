  ...
  return (
    <>
      ...
      <section id="expenditure_cards" className="lg:col-span-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white/80 dark:bg-[#090b1c]/80 backdrop-blur-xl p-5 rounded-2xl border border-emerald-500/20 shadow-[0_0_20px_rgba(16,185,129,0.05)] relative overflow-hidden group">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[11px] text-slate-600 dark:text-slate-400">Aggregated electricity and petroleum invoices.</p>
          </div>
        </div>

        {/* Card 2: Maintenance Expenditures */}
        <div className="bg-white/80 dark:bg-[#090b1c]/80 backdrop-blur-xl p-5 rounded-2xl border border-amber-500/20 shadow-[0_0_20px_rgba(245,158,11,0.05)] relative overflow-hidden group">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[11px] text-slate-600 dark:text-slate-400">Total vehicle repair bills and dock sign-offs.</p>
          </div>
        </div>

        {/* Card 3: Total Fleet Cost (Grand Aggregate) */}
        <div className="bg-white/85 dark:bg-[#090b1c]/85 backdrop-blur-xl p-5 rounded-2xl border border-cyan-500/25 shadow-[0_0_25px_rgba(34,211,238,0.1)] relative overflow-hidden group">
      ...
      <div className="lg:col-span-12">
        <div className="p-4 bg-slate-50/80 dark:bg-slate-950/80 rounded-2xl border border-slate-300 dark:border-slate-900 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <div className="p-1.5 rounded-lg bg-cyan-950/50 border border-cyan-500/10 text-cyan-400 font-mono text-xs font-bold">
              ∑
            </div>
            <div>
              <span className="text-[9.5px] font-mono text-slate-600 dark:text-slate-400 tracking-wider uppercase block">LEDGER MATH EQUATION ENGINE</span>
              <span className="text-xs font-mono font-bold text-slate-700 dark:text-slate-300">Total Operational Cost Formula</span>
            </div>
          </div>

          {/* Graphical Equation Layout */}
          <div className="flex items-center gap-2.5 font-mono text-xs sm:text-sm text-slate-600 dark:text-slate-400 flex-wrap justify-center">
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-3 py-1.5 rounded-xl text-emerald-400 font-bold flex flex-col items-center">
              <span className="text-[8px] text-slate-600 dark:text-slate-400">FUEL & CHARGING</span>
              <span>${totalFuelCost.toLocaleString()}</span>
            </div>
            <span className="text-xl text-slate-600">+</span>
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-3 py-1.5 rounded-xl text-amber-500 font-bold flex flex-col items-center">
              <span className="text-[8px] text-slate-600 dark:text-slate-400">MAINTENANCE BILLS</span>
            ...
            <div className="bg-cyan-950/40 border border-cyan-500/20 px-3.5 py-1.5 rounded-xl text-cyan-400 font-black flex flex-col items-center shadow-[0_0_15px_rgba(34,211,238,0.1)]">
              <span className="text-[8px] text-slate-600 dark:text-slate-400">TOTAL COMBINED</span>
      ...
      <section id="interactive_charts" className="lg:col-span-6 h-full">
        <div className="bg-white/80 dark:bg-[#090b1c]/80 backdrop-blur-xl p-6 rounded-3xl border border-slate-200 dark:border-slate-800 flex flex-col gap-4 h-full min-h-[480px]">
          
          <div className="border-b border-slate-200 dark:border-slate-800 pb-3 flex items-center justify-between">
            <div>
              <h3 className="text-xs font-mono font-bold tracking-widest text-slate-800 dark:text-slate-200">INTERACTIVE MONTHLY EXPENDITURES</h3>
              <p className="text-[10px] text-slate-600 dark:text-slate-400 font-mono">Dynamic historical SVG chart tracking Fuel vs Maintenance costs</p>
            </div>
          ...
          <div className="flex-1 flex flex-col justify-center py-4 relative">
            <div className="h-[240px] w-full relative flex items-end justify-between px-6 border-b border-l border-slate-200 dark:border-slate-800/80">
              
              {/* Y Axis Grid Lines */}
              <div className="absolute left-0 right-0 border-t border-slate-300 dark:border-slate-900/50" style={{ bottom: "25%" }} />
              <div className="absolute left-0 right-0 border-t border-slate-300 dark:border-slate-900/50" style={{ bottom: "50%" }} />
              <div className="absolute left-0 right-0 border-t border-slate-300 dark:border-slate-900/50" style={{ bottom: "75%" }} />
              ...
              {monthlyData.map((d, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isHovered && (
                      <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-slate-50 dark:bg-slate-950 border border-cyan-500/40 px-3 py-2 rounded-xl text-[10px] font-mono w-44 z-10 text-center shadow-xl animate-fade-in">
                        ...
                        <div className="border-t border-slate-300 dark:border-slate-900 mt-1.5 pt-1 flex justify-between font-bold text-slate-900 dark:text-white">
                          <span>Total:</span>
                    ...
                    <span className="text-[10px] font-mono text-slate-600 dark:text-slate-400 mt-2">{d.month}</span>
                  </div>
                );
              })}
            ...
            {/* Chart Legend */}
            <div className="flex justify-center gap-6 text-[10px] font-mono text-slate-600 dark:text-slate-400 pt-5">
              <div className="flex items-center gap-2">
      ...
      <section id="ledger_controls" className="lg:col-span-6 h-full flex flex-col gap-6">
        ...
        <div className="bg-white/85 dark:bg-[#090b1c]/85 backdrop-blur-xl p-5 rounded-3xl border border-slate-200 dark:border-slate-800 flex flex-col gap-4">
          <div className="border-b border-slate-200 dark:border-slate-800 pb-3">
            ...
            <p className="text-[10px] text-slate-600 dark:text-slate-400 font-mono mt-0.5">Authorize and file official fleet expense vouchers into databases.</p>
          </div>
          ...
          <form onSubmit={handleLogExpense} className="space-y-4 font-mono text-xs">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] text-slate-600 dark:text-slate-400 block">SELECT VEHICLE</label>
                <select 
                  value={selectedVehId}
                  onChange={(e) => setSelectedVehId(e.target.value)}
                  className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 px-3 py-2 rounded-xl text-slate-900 dark:text-white focus:outline-none cursor-pointer"
                >
                  {vehicles.map(v => (
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] text-slate-600 dark:text-slate-400 block">EXPENSE CLASSIFICATION</label>
                <div className="flex gap-2 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 p-1.5 rounded-xl">
                  <button
                    type="button"
                    onClick={() => {
                      setLogType("fuel");
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] text-slate-600 dark:text-slate-400 block">TOTAL USD CHARGE ($)</label>
                <input 
                  type="text"
                  placeholder="e.g. 520.00"
                  value={expenseCost}
                  onChange={(e) => setExpenseCost(e.target.value)}
                  className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 px-3 py-2.5 rounded-xl text-slate-900 dark:text-white focus:outline-none placeholder:text-slate-600"
                />
              </div>

              <div className="space-y-1.5">
                <label className="text-[10px] text-slate-600 dark:text-slate-400 block">QUANTITY (Only if Fuel Type)</label>
                <input 
                  type="text"
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 px-3 py-2.5 rounded-xl text-slate-900 dark:text-white focus:outline-none placeholder:text-slate-600 disabled:opacity-40"
                />
              </div>
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] text-slate-600 dark:text-slate-400 block">DETAILED DESCRIPTION</label>
              <input 
                type="text"
        ...
        <div className="bg-white/85 dark:bg-[#090b1c]/85 backdrop-blur-xl p-5 rounded-3xl border border-slate-200 dark:border-slate-800 flex flex-col gap-4 flex-1 max-h-[300px]">
            ...
            {[
              ...
              .map((log, index) => {
                ...
                return (
                  <div 
                    key={`${log.id}-${index}`}
                    className="p-3 bg-slate-50/40 dark:bg-slate-950/40 rounded-xl border border-slate-200 dark:border-slate-800/60 text-xs font-mono flex items-center justify-between"
                  >
                    <div>
                      <div className="flex items-center gap-2">
                    ...
                    <div className="text-right shrink-0">
                      ...
                      {isFuel && <span className="text-[8.5px] text-slate-600 dark:text-slate-400 block">{(log as any).amountAdded}</span>}
                    </div>
                  </div>
                );
              })}
